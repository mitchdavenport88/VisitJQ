const jewelleryQuarterPlaces = {
    'travel': [{
            location: {
                lat: 52.4901528320036,
                lng: -1.9128514235878478
            },
            ...
            addInfo: 'Jewellery Quarter station is a combined railway station and tram stop. The station is served by West Midlands Trains, Chiltern Railways, and Midland Metro.',
            website: 'https://www.nationalrail.co.uk/stations/JEQ/details.html',
            iconImage: 'assets/images/custom-markers/travel-marker.png'
        },
        {
            location: {
                lat: 52.4878009740022,
                lng: -1.9045687621959868
            },
            ...
            addInfo: 'St Paul\'s tram stop is a tram stop serving nearby St Paul\'s Square. It\'s on the Midland Metro Line 1. The stop is a short distance west of Birmingham Snow Hill station, which is visible from the stop.',
            website: 'https://westmidlandsmetro.com/journey-planner/',
            iconImage: 'assets/images/custom-markers/travel-marker.png'
        },
        {
            location: {
                lat: 52.48539672250407,
                lng: -1.900320143140058
            },
            ...
            addInfo: 'St Chads tram stop is a tram stop on the city-centre extension of Line 1 of the West Midlands Metro in the United Kingdom, adjacent to Snow Hill railway station.',
            website: 'https://westmidlandsmetro.com/journey-planner/',
            iconImage: 'assets/images/custom-markers/travel-marker.png'
        },
        {
            location: {
                lat: 52.48486097459022,
                lng: -1.9067359870446474
            },
            ...
            reviewTitle: '"Nice car park with daytime security"',
            review: '"Practical, located conveniently and with plenty of spaces all with good width ramps to save your alloys. Coupled with about what youd expect to have to pay"',
        ...
        {
            location: {
                lat: 52.485945530560144,
                lng: -1.9082809394286215
            },
            ...
            reviewTitle: '"Always tidy"',
            review: '"I work in St. Paul’s Sqaure so it’s a fab location for me, closest carpark by far. Well signed & super easy as they have pay by phone! Always nice and clean too."',
            website: 'https://www.parkme.com/en-gb/lot/203189/northwood-street-car-park-birmingham-uk',
            iconImage: 'assets/images/custom-markers/parking-marker.png'
        },
        {
            location: {
                lat: 52.48864289135307,
                lng: -1.9123442850248518
            },
            ...
            reviewTitle: '"Plenty of spaces"',
            review: '"Clean well lit and monitored, good range of payment choices, central location and sensible pricing."',
    ...
    'eat': [{
            location: {
                lat: 52.485233583417745,
                lng: -1.907818886868876
            },
            name: 'Lasan',
        ...
        {
            location: {
                lat: 52.48478930352097,
                lng: -1.904278370988886
            },
            name: 'Cucino Rustica',
        ...
        {
            location: {
                lat: 52.486494529859975,
                lng: -1.9077867003608273
            },
        ...
        {
            location: {
                lat: 52.48724097715667,
                lng: -1.9022578733768014
            },
            name: 'Hen & Chickens',
            title: 'Cask & Curry',
        ...
        {
            location: {
                lat: 52.48742190894782,
                lng: -1.910550273376769
            },
            name: 'The Wilderness',
        ...
        {
            location: {
                lat: 52.48817237425163,
                lng: -1.9086907887207132
            },
            name: 'Devon House',
        ...
        {
            location: {
                lat: 52.4848962851702,
                lng: -1.905125102212869
            },
        ...
        {
            location: {
                lat: 52.48916110530588,
                lng: -1.907403086868705
            },
            name: '3 Three\'s',
    ...
    'drink': [{
            location: {
                lat: 52.4859748503573,
                lng: -1.911887096396719
            },
            name: 'Button Factory',
        ...
        {
            location: {
                lat: 52.48628191834437,
                lng: -1.90588967705836
            },
            name: '40 St. Paul\'s',
            title: 'Gin Bar',
        ...
        {
            location: {
                lat: 52.49053818291137,
                lng: -1.9090654124942905
            },
            name: 'The Clifden',
            title: 'Pub',
        ...
        {
            location: {
                lat: 52.4897411854693,
                lng: -1.9080998172563377
            },
            name: 'The Church Inn',
            title: 'Pub',
        ...
        {
            location: {
                lat: 52.487203398063805,
                lng: -1.912272653529681
            },
        ...
        {
            location: {
                lat: 52.48475021851283,
                lng: -1.914261644540896
            },
            name: 'The Pig & Tail',
            title: 'Craft Beer',
        ...
        {
            location: {
                lat: 52.48527290076547,
                lng: -1.9115579778360996
            },
            name: '1000 Trades',
        ...
        {
            location: {
                lat: 52.48460055345065,
                lng: -1.9047363887208995
            },
            name: 'Actress & Bishop',
    ...
    'explore': [{
            location: {
                lat: 52.489142096340736,
                lng: -1.9054979818528697
            },
        ...
        {
            location: {
                lat: 52.48805127534349,
                lng: -1.9088433291967155
            },
        ...
        {
            location: {
                lat: 52.49071773670097,
                lng: -1.9121763110283405
            },
        ...
        {
            location: {
                lat: 52.48466955237686,
                lng: -1.9115684022128796
            },
            name: 'Pen Museum',
            title: 'Museum',
        ...
        {
            location: {
                lat: 52.48518301767432,
                lng: -1.9047868157048553
            },
            name: 'The Jam House',
        ...
        {
            location: {
                lat: 52.48214766486217,
                lng: -1.9074573598849893
            },
        ...
        {
            location: {
                lat: 52.484885306136476,
                lng: -1.9062986455695912
            },
        ...
        {
            location: {
                lat: 52.487245044652205,
                lng: -1.912838244540768
            },
    ...
    'sleep': [{
            location: {
                lat: 52.486154447304486,
                lng: -1.9118621157048172
            },
        ...
        {
            location: {
                lat: 52.48584591466117,
                lng: -1.9050990733768165
            },
        ...
        {
            location: {
                lat: 52.48656458322476,
                lng: -1.9042729530048232
            },
            name: 'Hatters Hostel',
            title: 'Hostel',
        ...
        {
            location: {
                lat: 52.48364848711359,
                lng: -1.9069400310489426
            },
        ...
        {
            location: {
                lat: 52.48317152221384,
                lng: -1.9075837612089317
            },
        ...
        {
            location: {
                lat: 52.48630778013889,
                lng: -1.9078760868688185
            },
            name: 'Bloc Hotel',
        ...
        {
            location: {
                lat: 52.48200195625742,
                lng: -1.9065645217889486
            },
        ...
        {
            location: {
                lat: 52.48606604605024,
                lng: -1.917875362050885
            },
